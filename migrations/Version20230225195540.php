 ...
 */
final class Version20230225195540 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE boite (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(919) NOT NULL, editeur VARCHAR(30) DEFAULT NULL, annee VARCHAR(20) DEFAULT NULL, imageBlob LONGBLOB NOT NULL, slug VARCHAR(255) DEFAULT NULL, is_livrable TINYINT(1) NOT NULL, is_complet TINYINT(1) NOT NULL, poid_boite VARCHAR(255) DEFAULT NULL, age VARCHAR(10) DEFAULT NULL, nbr_joueurs VARCHAR(4) DEFAULT NULL, prix_ht VARCHAR(8) DEFAULT NULL, is_deee TINYINT(1) DEFAULT NULL, contenu TEXT DEFAULT NULL, message VARCHAR(255) DEFAULT NULL, is_on_line TINYINT(1) NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', creator VARCHAR(255) NOT NULL, rvj2_id INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE configuration (id INT AUTO_INCREMENT NOT NULL, devis_delay_before_delete DOUBLE PRECISION NOT NULL, prefixe_facture VARCHAR(5) NOT NULL, prefixe_devis VARCHAR(5) NOT NULL, cost INT NOT NULL, grand_plateau_bois VARCHAR(50) NOT NULL, grand_plateau_plastique VARCHAR(50) NOT NULL, petit_plateau_bois VARCHAR(50) NOT NULL, petit_plateau_plastique VARCHAR(50) NOT NULL, piece_unique VARCHAR(50) NOT NULL, piece_multiple VARCHAR(50) NOT NULL, piece_metal_bois VARCHAR(50) NOT NULL, autre_piece VARCHAR(50) NOT NULL, enveloppe_simple VARCHAR(50) NOT NULL, enveloppe_bulle VARCHAR(50) NOT NULL, holiday VARCHAR(255) DEFAULT NULL, version_site VARCHAR(10) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE informations_legales (id INT AUTO_INCREMENT NOT NULL, country_id INT NOT NULL, adresse_societe VARCHAR(255) NOT NULL, siret_societe INT NOT NULL, adresse_mail_site VARCHAR(255) NOT NULL, societe_webmaster VARCHAR(255) NOT NULL, nom_webmaster VARCHAR(255) NOT NULL, nom_societe VARCHAR(255) NOT NULL, site_url VARCHAR(255) NOT NULL, hebergeur_site VARCHAR(255) NOT NULL, taux_tva INT NOT NULL, INDEX IDX_2618D3A5F92F3E70 (country_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE occasion (id INT AUTO_INCREMENT NOT NULL, boite_id INT NOT NULL, document_id INT DEFAULT NULL, reference VARCHAR(255) DEFAULT NULL, price_ht VARCHAR(10) NOT NULL, old_price_ht VARCHAR(210) NOT NULL, information LONGTEXT DEFAULT NULL, is_neuf TINYINT(1) NOT NULL, etat_boite VARCHAR(255) NOT NULL, etat_materiel VARCHAR(255) NOT NULL, regle_jeu VARCHAR(255) NOT NULL, is_on_line TINYINT(1) NOT NULL, is_donation TINYINT(1) NOT NULL, is_sale TINYINT(1) NOT NULL, donation DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', sale DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', means_of_sale VARCHAR(20) DEFAULT NULL, stock VARCHAR(1) NOT NULL, prix_de_vente VARCHAR(8) DEFAULT NULL, rvj2_id INT DEFAULT NULL, INDEX IDX_8A66DCE53C43472D (boite_id), INDEX IDX_8A66DCE5C33F7837 (document_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE paiement (id INT AUTO_INCREMENT NOT NULL, token_transaction VARCHAR(255) NOT NULL, time_transaction DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', moyen_paiement VARCHAR(50) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE panier_image (id INT AUTO_INCREMENT NOT NULL, panier_id INT NOT NULL, image LONGBLOB NOT NULL, INDEX IDX_EC102BE2F77D927C (panier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, country_id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, phone VARCHAR(20) NOT NULL, department VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', nickname VARCHAR(255) DEFAULT NULL, level INT DEFAULT NULL, token VARCHAR(255) DEFAULT NULL, membership DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', rvj2_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649F92F3E70 (country_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ville (id INT AUTO_INCREMENT NOT NULL, departement_id INT NOT NULL, ville_code_postal VARCHAR(15) NOT NULL, ville_nom VARCHAR(255) NOT NULL, ville_departement VARCHAR(255) NOT NULL, lng VARCHAR(255) NOT NULL, lat VARCHAR(255) NOT NULL, pays VARCHAR(5) NOT NULL, rvj2_id INT DEFAULT NULL, INDEX IDX_43C3D9C3CCF9E01E (departement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
