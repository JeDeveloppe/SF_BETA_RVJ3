 ...
 */
final class Version20220708145704 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE informations_legales ADD country_id INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_2618D3A5F92F3E70 ON informations_legales (country_id)');
    }
