 ...
 */
final class Version20220310170304 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE informations_legales ADD hebergeur_site VARCHAR(255) NOT NULL');
    }
