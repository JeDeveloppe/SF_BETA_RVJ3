 ...
 */
final class Version20220310165000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE informations_legales ADD site_url VARCHAR(255) NOT NULL');
    }
