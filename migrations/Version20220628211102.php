 ...
 */
final class Version20220628211102 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document ADD is_delete_by_user TINYINT(1) DEFAULT NULL');
    }
