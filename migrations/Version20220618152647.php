 ...
 */
final class Version20220618152647 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE informations_legales ADD taux_tva NUMERIC(3, 2) NOT NULL');
    }
