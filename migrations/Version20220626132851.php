 ...
 */
final class Version20220626132851 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document CHANGE numero_devis numero_devis INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document CHANGE token token VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE numero_devis numero_devis INT DEFAULT NULL, CHANGE adresse_facturation adresse_facturation LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE adresse_livraison adresse_livraison LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
