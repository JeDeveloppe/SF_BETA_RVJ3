 ...
 */
final class Version20220620174602 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD country_id INT NOT NULL, DROP country');
