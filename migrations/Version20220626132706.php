 ...
 */
final class Version20220626132706 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE document_lignes (id INT AUTO_INCREMENT NOT NULL, boite_id INT DEFAULT NULL, occasion_id INT DEFAULT NULL, document_id INT NOT NULL, message LONGTEXT DEFAULT NULL, prix_vente DOUBLE PRECISION NOT NULL, INDEX IDX_D18A5C2C3C43472D (boite_id), INDEX IDX_D18A5C2C4034998F (occasion_id), INDEX IDX_D18A5C2CC33F7837 (document_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
