 ...
 */
final class Version20220629191438 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE paiement (id INT AUTO_INCREMENT NOT NULL, document_id INT NOT NULL, token_transaction VARCHAR(255) NOT NULL, time_transaction DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', moyen_paiement VARCHAR(20) NOT NULL, UNIQUE INDEX UNIQ_B1DC7A1EC33F7837 (document_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
