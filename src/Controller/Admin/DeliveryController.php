...
class DeliveryController extends AbstractController
{
    ...
    public function new(Request $request, DeliveryRepository $deliveryRepository): Response
    {
        ...
        return $this->renderForm('admin/delivery/new.html.twig', [
            'delivery' => $delivery,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('admin/delivery/show.html.twig', [
            'delivery' => $delivery,
        ]);
    }
    ...
    public function edit(Request $request, Delivery $delivery, DeliveryRepository $deliveryRepository): Response
    {
        ...
        return $this->renderForm('admin/delivery/edit.html.twig', [
            'delivery' => $delivery,
            'form' => $form,
        ]);
    }
